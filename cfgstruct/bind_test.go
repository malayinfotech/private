...
type TestStruct struct {
	...
	NodeURL             storx.NodeURL  `releaseDefault:"" devDefault:"12EayRS2V1kEsWESU9QMRseFhdxYxKicsiFmxrsLZHeLUtdps3S@mars.tardigrade.io:7777"`
	NodeURLs            storx.NodeURLs `releaseDefault:"" devDefault:"12EayRS2V1kEsWESU9QMRseFhdxYxKicsiFmxrsLZHeLUtdps3S@mars.tardigrade.io:7777,12L9ZFwhzVpuEKMUNUqkaTLGzwY9G24tbiigLiXpmZWKwmcNDDs@jupiter.tardigrade.io:7777"`
	Struct              struct {
...
func TestBind(t *testing.T) {
	...
	require.Equal(t, c.NodeURL, storx.NodeURL{})
	require.Equal(t, c.NodeURLs, storx.NodeURLs(nil))
	...
	node1, err := storx.NodeIDFromString("12EayRS2V1kEsWESU9QMRseFhdxYxKicsiFmxrsLZHeLUtdps3S")
	require.NoError(t, err)
	node2, err := storx.NodeIDFromString("12L9ZFwhzVpuEKMUNUqkaTLGzwY9G24tbiigLiXpmZWKwmcNDDs")
	require.NoError(t, err)
	...
	require.Equal(t, c.Duration, time.Hour)
	require.Equal(t, c.NodeURL, storx.NodeURL{ID: node1, Address: "mars.tardigrade.io:7777"})
	require.Equal(t, c.NodeURLs, storx.NodeURLs{
		storx.NodeURL{ID: node1, Address: "mars.tardigrade.io:7777"},
		storx.NodeURL{ID: node2, Address: "jupiter.tardigrade.io:7777"},
	})
...
func TestBindDevDefaults(t *testing.T) {
	...
	node3, err := storx.NodeIDFromString("121RTSDpyNZVcEU84Ticf2L1ntiuUimbWgfATz21tuvgk3vzoA6")
	require.NoError(t, err)
	...
	require.Equal(t, c.Float64, float64(1))
	require.Equal(t, c.Duration, time.Hour)
	require.Equal(t, c.NodeURL, storx.NodeURL{ID: node3, Address: "saturn.tardigrade.io:7777"})
	require.Equal(t, c.NodeURLs, storx.NodeURLs{storx.NodeURL{ID: node3, Address: "saturn.tardigrade.io:7777"}})
	require.Equal(t, c.Struct.AnotherString, string("1"))
	require.Equal(t, c.Fields[0].AnotherInt, int(6))
	require.Equal(t, c.Fields[3].AnotherInt, int(1))
}
