...
func ShouldUpdate(rollout Rollout, nodeID storx.NodeID) bool {
	return isRolloutCandidate(nodeID, rollout)
}

func isRolloutCandidate(nodeID storx.NodeID, rollout Rollout) bool {
...
func ShouldUpdateVersion(currentVersion SemVer, nodeID storx.NodeID, requested Process) (updateVersion Version, reason string, err error) {
	...
	// https://github.com/storx/storx/pull/2677#pullrequestreview-270882629
	// and storx/docs/blueprints/storage-node-automatic-updater.md
