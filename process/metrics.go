...
var (
	...
	metricCollector = flag.String("metrics.addr", flagDefault("", "collectora.storx:9000"), "address(es) to send telemetry to (comma-separated)")

	metricEventCollector = flag.String("metrics.event-addr", flagDefault("", "eventkitd.datasci.storx:9002"), "address(es) to send telemetry to (comma-separated)")
